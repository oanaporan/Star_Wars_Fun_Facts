...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Prices, [{
    key: "getCharDetails",
    value: function getCharDetails() {
      var _this2 = this;

      if (this.state.character) {
        var c = this.props.chars.filter(function (char) {
          return char.name === _this2.setState.character;
        });
        this.setState({
          character: c
        });
...
//# sourceMappingURL=index.js.246d761c95e8348156e0.hot-update.js.map